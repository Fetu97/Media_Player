    ...
    public partial class Form1 : Form
    {
        ...
        private void LoadFolderEvent(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.OK)
            {
                ...
                file.ToLower().EndsWith("wmv") || file.ToLower().EndsWith("mkv") || file.ToLower().EndsWith("mp3") || file.ToLower().EndsWith("aac") || file.ToLower().EndsWith("FFmpeg") || file.ToLower().EndsWith("wma") || file.ToLower().EndsWith("avi")).ToList();
        ...
        {
            MessageBox.Show("Made by Ferhat Arslan." + Environment.NewLine + "Welcome to my MediaPlayer", 
                "About this App: ");
        }
        ...
        private void MediaPlayerStateChangeEvent(object sender, AxWMPLib._WMPOCXEvents_PlayStateChangeEvent e)
        {
            ...
            {
                // if the media player is loading new video or sound
                lblDuration.Text = "Loading new file";
            }
        ...
        private void LoadPlayList()
        {
            ...
            {
                MessageBox.Show("No Files Found in this folder");
            }
        }
